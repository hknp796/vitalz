            ...
            <div className='w-[100%] h-[100%] md:w-[50%] flex justify-center items-center'>
                <form className='md:w-[40%] w-[80%] '>
                    ...
                    <div className="mb-6">
                        ...
                        <input type="password" id="email" className="text-white bg-[#121213] border border-gray-500  text-sm rounded-lg block w-full p-5 focus:ring-blue-500 " placeholder="name@flowbite.com" required />
                    </div>
